...
export default function Home() {
  ...
  return (
    <main className="">
       <section className="relative min-h-screen bg-gradient-to-b from-blue-950 via-blue-700 to-white/10">
      {/* Grid overlay background (optional) */}
      <div className="pointer-events-none absolute inset-0 opacity-40">
        <div className="h-full w-full bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.35),_transparent_60%),linear-gradient(to_right,#0f172a_1px,transparent_1px),linear-gradient(to_bottom,#0f172a_1px,transparent_1px)] bg-[size:100%_100%,4rem_4rem,4rem_4rem]" />
      </div>
        ...
        <div className="container px-4 py-8">
          ...
          <header className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-white">Autogram</span>
            </div>
            ...
            <nav className="hidden space-x-6 text-sm text-blue-200 md:block">
             <Button variant="outline" className="border-blue-400 text-black ">
          ...
          <div className="mx-auto mt-16 max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-blue-200">
              ...
              Instagram. Automate responses and boost engagement with smart
              workflows.
            </p>
